...
public class TSP {
    ...
    static private int compteurCalcul;
    static private int ordre[];
    ...
    static Tournee calculerTournee(Collection<Livraison> livraisonCollection, Livraison entrepot){
